...
- NoteRepository: db 에서 note 데이터를 꺼내옴 (crud 를 위함)
- NoteController: note crud
- NoteService: note crud 메소드 구현
...
- NoticeRepository: db 에서 공지 데이터를 꺼내옴 (crud 를 위함)
- NoticeController: 공지 crud
- NoticeService: 공지 crud 메소드 구현
